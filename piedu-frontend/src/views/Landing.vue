                    ...
                    <div class="col px-0">
                        <div class="row my-lg-3">
                            <div class="col-lg-6 mt-lg-4">
                                <h1 class="display-3  text-white">Hệ thống quản lý môn học
                                    <!--<span class="h4">Đại học Công Nghệ - ĐHQGHN</span>-->
                                </h1>
                                <!--<p class="lead  text-white">Đại học Công Nghệ - Đại Học Quốc Gia Hà Nội</p>-->
                                ...
                                <div class="btn-wrapper">
                                    <router-link v-if="username!=null" :to="{name:'login'}"
                                        ...
                                        <span class="nav-link-inner--text">Khám phá lớp học</span>
                                    </router-link>
                                    <router-link v-else :to="{name:'login'}"
                                        ...
                                        <span class="nav-link-inner--text">Đăng nhập ngay</span>
                                    </router-link>

                                </div>
                            </div>
                            <div class="col-lg-6 d-node d-lg-block">
                                <img src="../assets/images/tea.svg" alt="" class="w-100">
                            </div>
                        </div>
                    </div>
                </div>
